                        ...
                        <!-- Nav Item - Messages -->
                         ...
                         <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{url("aconge")}}">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">reunion
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">2</div>
                                                </div>
                                                <!-- Earnings (ligne de calcul) Card Example -->
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas  fa-2x text-gray-300"></i>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <h4 class="small font-weight-bold">Gestion de l'irrigation <span
                class="float-right">75%</span></h4>
        <div class="progress mb-4">
            <div class="progress-bar bg-danger" role="progressbar" style="width: 75%"
                aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <h4 class="small font-weight-bold">Protection des écosystèmes aquatiques <span
                class="float-right">incomplet!</span></h4>
        <div class="progress mb-4">
            <div class="progress-bar bg-warning" role="progressbar" style="width: 0%"
                aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <h4 class="small font-weight-bold">Gestion des ressources en eau <span
                class="float-right">91%</span></h4>
        <div class="progress mb-4">
            <div class="progress-bar" role="progressbar" style="width: 91%"
                aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <h4 class="small font-weight-bold">Amélioration de l'accès à l'eau potable <span
                class="float-right">Complete!</span></h4>
        <div class="progress mb-4">
            <div class="progress-bar bg-info" role="progressbar" style="width: 100%"
                aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <h4 class="small font-weight-bold">Prévention des inondations <span
...
<!-- Color System -->
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Recents Activité</h6>
                                </div>
                               
                                <a class="dropdown-item d-flex align-items-center" href="{{url("aannonce")}}">
                                    <div class="dropdown-list-image mr-3">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Conférence</div>
                                        <div class="small text-gray-500">hamza · 58m</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="{{url("aannonce")}}">
                                    <div class="dropdown-list-image mr-3">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">les noveau serveur</div>
                                        <div class="small text-gray-500">hamza · 7h</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="{{url("areunion")}}">
                                    <div class="dropdown-list-image mr-3">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">l'installation de l'eau</div>
                                        <div class="small text-gray-500">hamza · 1d</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="{{url("areunion")}}">
                                    <div class="dropdown-list-image mr-3">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">une fête</div>
                                        <div class="small text-gray-500">hamza · 2d</div>
                                    </div>
                                </a>
                                <a class="dropdown-item text-center small text-gray-500" href="#">Read More Activité</a>
                            </div>
