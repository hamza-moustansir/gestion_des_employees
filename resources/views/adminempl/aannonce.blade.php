        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Liste Des Annoncement</h1>
                        <a href="{{url("aannonce/caannonce")}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class=" fa-sm text-white-50"></i> nouveux Annonce</a>
                    </div>
                    ...
                    <th>action</th>
                                    ...
                                    @foreach($aannonces as $aannonce)
                                        <tr>
                                        <td>{{ $aannonce->titre}}</td>
                        <td>{{ $aannonce->contenu}}</td>
                        <td>
                        <form action="{{url("aannonce/". $aannonce->id)}}" method="post">
                            {{csrf_field()}}
                            {{method_field("DELETE")}}
                            <a href="{{url("aannonce/". $aannonce->id . "/eaannonce")}}" class="btn btn-warning">edit</a>
