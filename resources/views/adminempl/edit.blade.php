        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Edite Employé</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{url("list/".$employe->id)}}" method="post" >
            <input type="hidden" name="_method" value="PUT">
                {{csrf_field()}}
                <div class="form-group">
                <label for="">nom</label>
                <input type="text" name="nom" class="form-control" value="{{$employe->nom}}">
                </div>
                <div class="form-group">
                <label for="">prenom</label>
                <input type="text" name="prenom" class="form-control" value="{{$employe->prenom}}">
                </div>
                <div class="form-group">
                ...
                <input type="text" name="numero" class="form-control" value="{{$employe->numero}}">
                </div>
                <div class="form-group">
                ...
                <input type="text" name="salaire" class="form-control" value="{{$employe->salaire}}">
                </div>

                <div class="form-group">
                <input type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="modifier">
                </div>
            </form>
                            </div>
                        </div>
