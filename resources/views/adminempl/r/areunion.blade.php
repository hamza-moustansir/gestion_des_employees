        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Liste Des Reunions</h1>
                        <a href="{{url("areunion/creunion")}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class=" fa-sm text-white-50"></i> nouveux Reunion</a>
                    </div>
                    ...
                    <th>action</th>
                                    ...
                                    <tbody>
                                    @foreach($reunions as $areunion)
                                        <tr>
                                        <td>{{ $areunion->titre}}</td>
                        <td>{{ $areunion->type}}</td>
                        <td>{{ $areunion->date}}</td>
                        <td>{{ $areunion->heure}}</td>
                        <td>
                        <form action="{{url("areunion/". $areunion->id)}}" method="post">
                            {{csrf_field()}}
                            {{method_field("DELETE")}}
                            <a href="{{url("areunion/". $areunion->id . "/ereunion")}}" class="btn btn-warning">edit</a>
