        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Edit Reunion</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{url("areunion/".$areunion->id)}}" method="post" >
            <input type="hidden" name="_method" value="PUT">
                {{csrf_field()}}
                <div class="form-group">
                <label for="">titre</label>
                <input type="text" name="titre" class="form-control" value="{{$areunion->titre}}">
                </div>
                <div class="form-group">
                <label for="">type</label>
                <input type="text" name="type" class="form-control" value="{{$areunion->type}}">
                </div>
                <div class="form-group">
                <label for="">date</label>
                <input type="date" name="date" class="form-control" value="{{$areunion->date}}">
                </div>
                <div class="form-group">
                <label for="">heure</label>
                <input type="time" name="heure" class="form-control" value="{{$areunion->heure}}">
                </div>
                <div class="form-group">
