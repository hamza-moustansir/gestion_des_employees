        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Reponse</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{url("aconge/".$conge->id)}}" method="post" >
            <input type="hidden" name="_method" value="PUT">
                {{csrf_field()}}
                
                <label for="">status</label> 
             <select name="status" id="">
                <option value="accepte" name="status">accepte</option>
                <option value="refuser" name="status">refuser</option>
             </select> <br> <br>
