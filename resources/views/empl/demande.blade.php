...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url("accueil")}}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url("conge")}}">
                    <i class=""></i>
                    <span>Congé</span></a>
            </li>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link" href="{{url("reunion")}}">
                    <i class="  "></i>
                    <span>Reunion</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Nouveau Annonce</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="text-truncate">Nouveau Reunion</div>
                                        <div class="small text-gray-500">Admin · 7h</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">zidan</span>
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">nouveau Demande</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{url("conge")}}" method="post" >
                {{csrf_field()}}
                ...
                <select name="type" id="">
                <option value="maladé" name="type">maladé</option>
                <option value="administratif" name="type">administratif</option>
                <option value="maternité" name="type">maternité</option>
                </select>
                ...
                <div class="form-group">
                <input type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="enrigster">
                </div>
            </form>
                            </div>
                        </div>
